...
//   model = "\z\misery\addons\assets\data\models\dirtyguitar.p3d";
//   scope = 2;
//   scopeCurator = 2;
...
// //  model = "\z\misery\addons\assets\data\models\cigar.p3d";
//   scope = 2;
//   scopeCurator = 2;
...
//   model = "\z\misery\addons\assets\data\models\Autobatt.p3d";
//   scope = 2;
//   scopeCurator = 2;
...
class Misery_Stonechunk : Misery_ItemCore {
  ...
  //model = "\z\misery\addons\assets\data\models\stone.p3d";
  scope = 2;
  scopeCurator = 2;
...
class Misery_Ironore : Misery_ItemCore {
 ...
 // model = "\z\misery\addons\assets\data\models\iron.p3d";
  scope = 2;
  scopeCurator = 2;
...
class Misery_Goldore : Misery_ItemCore {
 ...
 // model = "\z\misery\addons\assets\data\models\gold.p3d";
  scope = 2;
  scopeCurator = 2;
...
//  model = "\z\misery\addons\assets\data\models\coal.p3d";
  scope = 2;
  scopeCurator = 2;
...
//  model = "\z\misery\addons\assets\data\models\gem.p3d";
  scope = 2;
  scopeCurator = 2;
