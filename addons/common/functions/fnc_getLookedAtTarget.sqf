...
getCameraViewDirection ACE_player params ["_vectorA", "_vectorB", "_vectorC"];
eyePos ACE_player params ["_eyePosA", "_eyePosB", "_eyePosC"];

private _endPos = [_eyePosA + _vectorA * _distance, _eyePosB + _vectorB * _distance, _eyePosC + _vectorC * _distance];

private _intersections = lineIntersectsSurfaces [[_eyePosA, _eyePosB, _eyePosC], _endPos, ACE_player, objNull, true, 1, "GEOM", "NONE"];
