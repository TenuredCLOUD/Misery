/*
Misery Module startup function (Medzone)
...
if (_activated) then {
	...
	[[_module, _units], "\z\misery\addons\framework\scripts\Modules\Medzone\Medzone.sqf"] remoteExec ["execVM ", [0, -2] select isDedicated, true];
};
