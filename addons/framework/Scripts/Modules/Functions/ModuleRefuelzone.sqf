/*
Misery Module startup function (Refuel zone)
...
if (_activated) then {
	...
	[[_module, _units], "\z\misery\addons\framework\scripts\Modules\Refuel\Refuelzone.sqf"] remoteExec ["execVM ", [0, -2] select isDedicated, true];
};
