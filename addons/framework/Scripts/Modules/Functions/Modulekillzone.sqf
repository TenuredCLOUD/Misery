/*
Misery Module startup function (Killzone)
...
if (_activated) then {
	[[_module, _units], "\z\misery\addons\framework\scripts\Modules\Killzone\Killzone.sqf"] remoteExec ["execVM ", [0, -2] select isDedicated, true];
};
