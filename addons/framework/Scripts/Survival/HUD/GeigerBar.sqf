...
[{"Misery_personalgeiger" in magazines player},
{
	[{
		...
		private _randomGeiger = selectRandom ["\z\misery\addons\framework\audio\sounds\inventory\Items\Geiger001.ogg",
		"\z\misery\addons\framework\audio\sounds\inventory\Items\Geiger002.ogg",
		"\z\misery\addons\framework\audio\sounds\inventory\Items\Geiger006.ogg",
		"\z\misery\addons\framework\audio\sounds\inventory\Items\Geiger007.ogg",
		"\z\misery\addons\framework\audio\sounds\inventory\Items\Geiger008.ogg"
		];
