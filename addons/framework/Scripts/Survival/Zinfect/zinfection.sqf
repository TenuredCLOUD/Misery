...
player setVariable ["zednotif", format ["<t>Possible Infection... <img shadow='0' size='1.5' image='%1'/>", "\z\misery\addons\framework\scripts\survival\Zinfect\icons\zedhand.paa"]];
