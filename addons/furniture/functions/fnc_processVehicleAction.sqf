...
{
    params ["_args"];
    _args params ["_className", "_vehicle", "_actionType", "_caller", "_target", "_actionId", "_dialog", "_interrupt", "_unloadButton", "_exitButton", "_vehicleName", "_displayName", "_progressBar"];
...
[_className, _vehicle, _actionType, _caller, _target, _actionId, _dialog, _interrupt, _unloadButton, _exitButton, _vehicleName, _displayName, _progressBar]] call CBA_fnc_progressBar;
