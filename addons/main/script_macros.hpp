...
#define MACRO_GEMTYPES  "Misery_Malachite", "Misery_Ruby", "Misery_Sapphire", "Misery_Amethyst", "Misery_Diamond", "Misery_Emerald"

// Player Status
#define MACRO_PLAYER_COOKING_RECIPES []
#define MACRO_PLAYER_CRAFTING_RECIPES []
#define MACRO_PLAYER_CURRENCY 0
#define MACRO_PLAYER_CURRENCY_BANKED 0
#define MACRO_PLAYER_DEBUFFS []
#define MACRO_PLAYER_EXPOSURE 0
#define MACRO_PLAYER_FATIGUE 0
#define MACRO_PLAYER_FEAR 0
#define MACRO_PLAYER_HUNGER 100
#define MACRO_PLAYER_INFECTION 0
#define MACRO_PLAYER_RADIATION 0
#define MACRO_PLAYER_THIRST 100
#define MACRO_PLAYER_TOXICITY 0
#define MACRO_PLAYER_WATERCOLLECT_RECIPES []
