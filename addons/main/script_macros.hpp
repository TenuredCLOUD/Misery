...
#define MACRO_ARTIFACTS QCLASS(artifact01), QCLASS(artifact02), QCLASS(artifact03), QCLASS(artifact04), QCLASS(artifact05), QCLASS(artifact06), QCLASS(artifact07), QCLASS(artifact08), QCLASS(artifact09), QCLASS(artifact10)
