...
_coolantInterrupt = (findDisplay 274839) displayAddEventHandler ["KeyDown", {
    ...
    if (_key isEqualTo DIK_ESCAPE) then {
        ...
        [QEGVAR(common,tileText), format ["Adding coolant interrupted..."]] call CBA_fnc_localEvent;
    };
}];
...
if (_currentCoolantLevel >= 1) exitWith {
    ...
    ctrlSetText [1001, format ["%1 coolant is full...", [_vehicle] call EFUNC(common,getObjectData) select 0]];
...
[{
    ...
    ctrlSetText [1001, format ["%1%2%3%2%4%2%5", _text, endl, [_vehicle] call EFUNC(common,getObjectData) select 0, _coolantLvl, (_currentCoolantLevel) * 100]];
