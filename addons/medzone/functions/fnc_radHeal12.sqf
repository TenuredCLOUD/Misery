 ...
 *
 * Example:
 * [] call misery_medzone_fnc_radHeal12;
 *
 * Public: No
*/
...
_pricerads = parseNumber (((((player getVariable ["MiseryRadiation",0]) * 0.5) / 50) * Mis_Medpriceradheal) toFixed 1);
...
_priceradscalc = parseNumber (((player getVariable ["MiseryRadiation",0]) * 0.5) toFixed 1);
