...
_pricerads = parseNumber (((((player getVariable ["MiseryRadiation",0]) * 0.25) / 50) * Mis_Medpriceradheal) toFixed 1);
...
_priceradscalc = parseNumber (((player getVariable ["MiseryRadiation",0]) * 0.25) toFixed 1);
