...
_pricerads = parseNumber ((((player getvariable ["radiation",0]) / 50) * Mis_Medpriceradheal) toFixed 1);
...
_priceradscalc = parseNumber ((player getvariable ["radiation",0]) toFixed 1);
