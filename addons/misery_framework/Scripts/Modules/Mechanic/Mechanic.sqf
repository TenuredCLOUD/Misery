...
//Get module inputs:
private _input1 =_module getvariable "Misery_Mechradius"; //Number
...
_trg setTriggerStatements ["(vehicle player) in thislist", "MiseryinVehiclerepairarea = true", "MiseryinVehiclerepairarea = false"]; //COND. ACTIVE. DEACTIVE.
...
if (MiseryDebug) then {
	...
	_t setMarkerTextLocal "Vehicle repair point";
};