...
//Get module inputs:
private _input1 =_module getvariable "Misery_MedZoneradius"; //Number
...
_trg setTriggerStatements ["(vehicle player) in thislist", "MiseryinMedzonearea = true", "MiseryinMedzonearea = false"]; //COND. ACTIVE. DEACTIVE.
...
if (MiseryDebug) then {
	...
	_t setMarkerTextLocal "Medical treatment area";
};