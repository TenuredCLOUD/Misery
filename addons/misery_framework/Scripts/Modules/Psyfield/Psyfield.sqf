...
//Get module inputs:
private _input1 =_module getvariable "Misery_Psyradius"; //Number
...
_trg setTriggerStatements ["(vehicle player) in thislist", "MiseryinPsyfield = true", "MiseryinPsyfield = false"]; //COND. ACTIVE. DEACTIVE.
...
if (MiseryDebug) then {
	...
	_t setMarkerTextLocal "Psyfield";
};