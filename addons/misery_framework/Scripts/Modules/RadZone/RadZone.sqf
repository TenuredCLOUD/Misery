...
//Get module inputs:
private _input1 =_module getvariable "Misery_RadiationRadius"; //Number
...
_trg setTriggerStatements ["(vehicle player) in thislist", "MiseryinRadZone = true", "MiseryinRadZone = false"]; //COND. ACTIVE. DEACTIVE.
...
if (MiseryDebug) then {
	...
	_t setMarkerTextLocal "Radiation Zone";
};