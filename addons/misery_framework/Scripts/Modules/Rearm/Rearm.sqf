...
//Get module inputs:
private _input1 =_module getvariable "Misery_Rearmradius"; //Number
...
_trg setTriggerStatements ["(vehicle player) in thislist", "MiseryinVehiclerearmarea = true", "MiseryinVehiclerearmarea = false"]; //COND. ACTIVE. DEACTIVE.
...
if (MiseryDebug) then {
	...
	_t setMarkerTextLocal "Vehicle rearm point";
};