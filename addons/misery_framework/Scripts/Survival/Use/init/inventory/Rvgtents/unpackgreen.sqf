...
[_tent, [("<t color=""#ffc600"">" + ("Pack Tent") + "</t>"), "Misery\Scripts\Survival\Use\init\inventory\Rvgtents\packgreen.sqf",[_tent], 1, false, true, "", "vehicle _this == _this"]] remoteExec ["addAction", 0, true];
