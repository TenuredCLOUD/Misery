...
[
	...
	player removeItem "NMIB_WoodNails_Itm"; 
  	...
  	player removeItem "Misery_Ironingot";
  	player removeItem "NMIB_WoodPlanks_Itm";
  	_todelete = [];
				...
				titleText ["You crafted a pickaxe...", "PLAIN DOWN"]; //completion text
...
[
	...
	player removeItem "Misery_woodnail"; 
  	player removeItem "Misery_Ironingot";
  	player removeItem "Misery_Ironingot";
  	player removeItem "Misery_woodplank";
  	_todelete = [];
