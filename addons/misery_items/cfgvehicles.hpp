...
class CfgVehicles {
	...
	class Misery_Forge : House_F {
		...
		model = "z\misery\addons\misery_items\data\models\other\forge.p3d";
		cost = 0;
		armor = 2000;
	...
	class Misery_Anvil : House_F {
		...
		textSingular = "Anvil";
		destrType = "DestructNo";
		model = "z\misery\addons\misery_items\data\models\other\medievalanvil.p3d";
	...
	class Misery_JetFuelRU : House_F {
		...
		destrType = "DestructNo";
		model = "z\misery\addons\misery_items\data\models\other\twinjetfueltank.p3d";
		...
		hiddenSelections[] = {};
		hiddenSelectionsTextures[] = {};
		hiddenSelectionsMaterials[] = {"z\misery\addons\misery_items\data\models\other\ui\Fueltanks.rvmat"};
	...
	class Misery_100KVA_Gen : House_F {
		...
		destrType = "DestructNo";
		model = "z\misery\addons\misery_items\data\models\other\100KVA_Generator.p3d";
		cost = 0;
		armor = 2000;
	...
	class Misery_HeavilyUsedGen_Gas : House_F {
		...
		destrType = "DestructNo";
		model = "z\misery\addons\misery_items\data\models\other\Used_Gen_Gas.p3d";
		cost = 0;
		armor = 2000;
	...
	class Misery_HeavilyUsedGen_Diesel : House_F {
		...
		destrType = "DestructNo";
		model = "z\misery\addons\misery_items\data\models\other\Used_Gen_Diesel.p3d";
		cost = 0;
		armor = 2000;
