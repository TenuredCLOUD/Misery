...
{
	idd = 982377;
	onLoad = "[] execVM 'Misery\Scripts\Survival\Functions\Menus\INVSTAT\Status.sqf';";
...
class Misery_ActionFW_ACTBUTTON: RscButton
{
	...
	onButtonClick ="TRUE execVM'Misery\Scripts\Inventory\SelectAction.sqf'";
};
class Misery_STATUSFW_Buffs_List: RscListBox
{
	...
	h = 2.5 * GUI_GRID_H;
	sizeEx = 0.7 * GUI_GRID_H;
	onLBSelChanged = "_this execVM 'Misery\Scripts\Survival\Functions\Menus\INVSTAT\ProcessBuff.sqf'";
};
class Misery_STATUSFW_Ailments_List: RscListBox
{
	...
	h = 2.5 * GUI_GRID_H;
	sizeEx = 0.7 * GUI_GRID_H;
	onLBSelChanged = "_this execVM 'Misery\Scripts\Survival\Functions\Menus\INVSTAT\ProcessAilment.sqf'";
};
