...
{
	idd = 274839;
	onLoad = "[] execVM 'Misery\Scripts\Survival\Functions\Menus\VehicleMaint\MaintListed.sqf'; [] execVM 'Misery\Scripts\Survival\Functions\Menus\VehicleMaint\Veh_icon.sqf';";
