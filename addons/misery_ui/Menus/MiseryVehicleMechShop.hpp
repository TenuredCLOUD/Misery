...
{
	idd = 982382;
	onLoad = "[] execVM 'Misery\Scripts\Survival\Functions\Menus\VehicleMechRepairs\MechListed.sqf'; [] execVM 'Misery\Scripts\Survival\Functions\Menus\VehicleMechRepairs\Veh_icon.sqf';";
...
class Misery_VehMechShopRepair_Purchase: RscButton
{
	...
	onButtonClick ="[] execVM 'Misery\Scripts\Survival\Functions\Menus\VehicleMechRepairs\ProcessPurchase.sqf';";
};
