...
{
	idd = 982384;
	onLoad = "[] execVM 'Misery\Scripts\Survival\Functions\Menus\VehicleRefuel\RefuelListed.sqf'; [] execVM 'Misery\Scripts\Survival\Functions\Menus\VehicleRefuel\Veh_icon.sqf';";
...
class Misery_VehShopRefuel_Purchase: RscButton
{
	...
	onButtonClick ="[] execVM 'Misery\Scripts\Survival\Functions\Menus\VehicleRefuel\ProcessPurchase.sqf';";
};
