...
{
	idd = 982380;
	onLoad = "[] execVM 'Misery\Scripts\Survival\Functions\Menus\WaterCollect\ContainersListed.sqf'; [] execVM 'Misery\Scripts\Survival\Functions\Menus\WaterCollect\Showicon.sqf';";
...
{
	idc = 1200;
	text = "\Misery\Scripts\Survival\Use\icons\well.paa";
...
class MiseryFillContainer_Button: RscButton
{
	...
	onButtonClick = "[] execVM 'Misery\Scripts\Survival\Functions\Menus\WaterCollect\ProcessFill.sqf';";
};
class MiseryDrinkFromSource_Button: RscButton
{
	...
	colorFocused[] = {0.5, 0.5, 0.5, 0.7};
	colorActive[] = {0.5, 0.5, 0.5, 0.7};
	onButtonClick = "[] execVM 'Misery\Scripts\Survival\Functions\Menus\WaterCollect\DrinkFromSource.sqf';";
};
