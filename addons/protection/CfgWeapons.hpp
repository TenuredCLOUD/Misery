class CfgWeapons {
    ...
    class VestItem;
    class V_RebreatherB;
    class CLASS(rebreather): V_RebreatherB {
        GVAR(gasmask) = 0;
        GVAR(scba) = 1;
        GVAR(skinProtection) = 0;
    ...
    class CLASS(rebreather_1): V_RebreatherIA {
        GVAR(gasmask) = 0;
        GVAR(scba) = 1;
        GVAR(skinProtection) = 0;
        GVAR(respiratoryProtection) = 1;
        ...
        class ItemInfo : VestItem {
            ...
            hiddenSelections[] = {"camo", "hide", "unhide", "unhide2"};
            hiddenSelectionsTextures[] = {
                "\A3\characters_f\common\data\diver_equip_rus_co.paa","\A3\characters_f\common\data\diver_equip_rus_co.paa","\A3\characters_f\data\visors_ca.paa"
            };
        };
    };

    class V_RebreatherIR;
    class CLASS(rebreather_2): V_RebreatherIR {
        GVAR(gasmask) = 0;
        GVAR(scba) = 1;
        GVAR(skinProtection) = 0;
        GVAR(respiratoryProtection) = 1;
        ...
        class ItemInfo : VestItem {
            ...
            hiddenSelections[] = {"camo", "hide", "unhide", "unhide2"};
            hiddenSelectionsTextures[] = {
                "\A3\characters_f\common\data\diver_equip_iran_co.paa","\A3\characters_f\common\data\diver_equip_iran_co.paa","\A3\characters_f\data\visors_ca.paa"
            };
        };
    };
};
