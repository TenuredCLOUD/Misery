...
/*
 * Author: TenuredCLOUD
 * Field thermal regulation kit usage
 *
 * Arguments:
 * None
 *
 ...
 *
 * Example:
 * [] call misery_temperature_fnc_thermalKit;
 *
*/

if (GVAR(thermalBagActive) || GVAR(thermalPackHeatActive) || GVAR(thermalPackColdActive)) exitWith {};

GVAR(thermalBagActive) = true;

[QCLASS(thermalRegulationKit)] call EFUNC(common,itemDecrement);
