...
{
	idd = 982379;
	onLoad = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Cooking\RecipesListed.sqf'; [] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Cooking\Showicon.sqf';";
...
{
	idc = 1501;
	text = "\\z\misery\addons\framework\scripts\survival\Use\icons\boilwater.paa";
...
class MiseryCooking_Button: RscButton
{
	...
	onButtonClick = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Cooking\ProcessRecipe.sqf';";
};
class MiseryCooking_KnownRecipes: RscButton
{
	...
	colorFocused[] = {0.5, 0.5, 0.5, 0.7};
	colorActive[] = {0.5, 0.5, 0.5, 0.7};
	onButtonClick = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Cooking\ShowRecipe.sqf';";
};
