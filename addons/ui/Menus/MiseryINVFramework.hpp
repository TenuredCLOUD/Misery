...
{
	idd = 982377;
	onLoad = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\invstat\Status.sqf';";
...
class Misery_ActionFW_ACTBUTTON: RscButton
{
	...
	onButtonClick ="TRUE execVM'\z\misery\addons\framework\scripts\Inventory\SelectAction.sqf'";
};
class Misery_STATUSFW_Buffs_List: RscListBox
{
	...
	h = 2.5 * GUI_GRID_H;
	sizeEx = 0.7 * GUI_GRID_H;
	onLBSelChanged = "_this execVM '\z\misery\addons\framework\scripts\survival\functions\menus\invstat\ProcessBuff.sqf'";
};
class Misery_STATUSFW_Ailments_List: RscListBox
{
	...
	h = 2.5 * GUI_GRID_H;
	sizeEx = 0.7 * GUI_GRID_H;
	onLBSelChanged = "_this execVM '\z\misery\addons\framework\scripts\survival\functions\menus\invstat\ProcessAilment.sqf'";
};
