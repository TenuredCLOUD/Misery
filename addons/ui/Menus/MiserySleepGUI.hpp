...
class MiserySleepGUI_Button: RscButton
{
    ...
    onButtonClick = "[player] execVM '\z\misery\addons\framework\scripts\survival\Sleep\hours\Sleep.sqf'; closeDialog 2;";
