...
{
	idd = 982390;
	onLoad = "_trader = player getVariable 'currentTrader'; _trader setVariable ['Misery_TraderIsBusy', true, true]; _trader setVariable ['Misery_TradingWith', profileName, true]; currentAction = 'buy'; [] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Trader\ShopVALs.sqf'; [] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Trader\ProcessCategory.sqf'; [] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Trader\ProcessMenuSwitch.sqf';"; 
...
class Misery_TraderShop_Sell_Sell: RscButton
{
	...
	onButtonClick = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Trader\ProcessBuy_Sell.sqf';";
};
class Misery_TraderShop_Sell_Gift: RscButton
{
	...
	colorFocused[] = {0.5, 0.5, 0.5, 0.7};
	colorActive[] = {0.5, 0.5, 0.5, 0.7};
	onButtonClick = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Trader\ProcessGift.sqf';";
};
class Misery_TraderShop_Sell_BuyMenu: RscButton
{
	...
	colorFocused[] = {0.5, 0.5, 0.5, 0.7};
	colorActive[] = {0.5, 0.5, 0.5, 0.7};
	onButtonClick = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Trader\ProcessMenuSwitch.sqf';";
};
