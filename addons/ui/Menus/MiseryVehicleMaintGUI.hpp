...
{
	idd = 274839;
	onLoad = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\VehicleMaint\MaintListed.sqf'; [] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\VehicleMaint\Veh_icon.sqf';";
