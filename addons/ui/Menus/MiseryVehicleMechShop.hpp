...
{
	idd = 982382;
	onLoad = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\VehicleMechRepairs\MechListed.sqf'; [] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\VehicleMechRepairs\Veh_icon.sqf';";
...
class Misery_VehMechShopRepair_Purchase: RscButton
{
	...
	onButtonClick ="[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\VehicleMechRepairs\ProcessPurchase.sqf';";
};
