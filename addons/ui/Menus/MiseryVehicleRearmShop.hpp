...
{
	idd = 982383;
	onLoad = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\VehicleRearm\RearmListed.sqf'; [] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\VehicleRearm\Veh_icon.sqf';";
...
class Misery_VehShopRearm_Purchase: RscButton
{
	...
	onButtonClick ="[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\VehicleRearm\ProcessPurchase.sqf';";
};
