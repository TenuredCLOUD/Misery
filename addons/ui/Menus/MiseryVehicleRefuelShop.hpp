...
{
	idd = 982384;
	onLoad = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\VehicleRefuel\RefuelListed.sqf'; [] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\VehicleRefuel\Veh_icon.sqf';";
...
class Misery_VehShopRefuel_Purchase: RscButton
{
	...
	onButtonClick ="[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\VehicleRefuel\ProcessPurchase.sqf';";
};
