...
{
	idd = 573849;
	onLoad = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Generator\Gen_PREP.sqf'; [] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Generator\Gen_icon.sqf';";
...
class Misery_Generator_Start_Stop_Button: RscButton
{
	...
	onButtonClick = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Generator\PowerButton.sqf'";
};
class Misery_Generator_Refuel_Button: RscButton
{
	...
	colorFocused[] = {0.5, 0.5, 0.5, 0.7};
	colorActive[] = {0.5, 0.5, 0.5, 0.7};
	onButtonClick = "[] execVM '\z\misery\addons\framework\scripts\survival\functions\menus\Generator\Refuel.sqf'";
		};
	};
};
