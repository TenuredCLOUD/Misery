...
{
    idd = 982377;
    onLoad = "[] execVM '\z\misery\addons\invstat\functions\fnc_Status.sqf';";
...
class CLASS(inventoryFramework_actionButton): RscButton
{
    ...
    onButtonClick ="[true] execVM '\z\misery\addons\inventory\functions\fnc_SelectAction.sqf'";
};
class CLASS(inventoryFramework_status_buffs_list): RscListBox
{
    ...
    h = 2.5 * GUI_GRID_H;
    sizeEx = 0.7 * GUI_GRID_H;
    onLBSelChanged = "_this execVM '\z\misery\addons\invstat\functions\fnc_ProcessBuff.sqf'";
};
class CLASS(inventoryFramework_status_ailments_list): RscListBox
{
    ...
    h = 2.5 * GUI_GRID_H;
    sizeEx = 0.7 * GUI_GRID_H;
    onLBSelChanged = "_this execVM '\z\misery\addons\invstat\funcitons\fnc_ProcessAilment.sqf'";
};
